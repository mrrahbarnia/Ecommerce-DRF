# Generated by Django 4.2 on 2024-01-27 10:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to=accounts.models.profile_img_file_path, validators=[accounts.validators.profile_image_size_validator], verbose_name='profile image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('province', models.CharField(max_length=150, null=True, verbose_name='province')),
                ...
                ('alley', models.CharField(max_length=150, null=True, verbose_name='alley')),
                ('floor', models.CharField(max_length=150, null=True, verbose_name='floor')),
                ('house_number', models.CharField(max_length=150, null=True, verbose_name='house number')),
                ('zip_code', models.CharField(max_length=150, null=True, verbose_name='zip code')),
                ('telephone_number', models.CharField(max_length=150, null=True, verbose_name='telephone number')),
                ('entire_address', models.CharField(max_length=150, null=True, verbose_name='entire address')),
